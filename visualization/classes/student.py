...
class Student:
    ...
    def __init__(self, 
        ...
        self.win_timetable = win_timetable
    ...
    def add_to_win_timetable(self, course: Course) -> None:
        """Add course to final timetable

        Args:
            course (Course): course to add
        """
        self.win_timetable.append(course)
    ...
    def __str__(self) -> str:
        return f"""id: {self.id}, year: {self.year}, degree: {self.degree}, 
            major: {self.major}, # timetable: {len(self.timetable)},  # win timetable: {len(self.win_timetable)}, # final timetable: {len(self.final_timetable)}"""
